...
const createProject = (local) => __awaiter(this, void 0, void 0, function* () {
...
const selectFolderAndDownload = (files, templateName, local, custom) => __awaiter(this, void 0, void 0, function* () {
...
const downloadTemplate = (files, templateName, folder, local, custom) => __awaiter(this, void 0, void 0, function* () {
