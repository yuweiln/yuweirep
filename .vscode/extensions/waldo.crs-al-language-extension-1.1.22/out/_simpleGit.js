...
function getGitStatusforFile(filePath) {
...
exports.getGitStatusforFile = getGitStatusforFile;
function GetGitStatus2(file) {
    simpleGit.status(function (error, status) {
        var fileList = [];
        if (error) {
            showOutput(error);
...
exports.GetGitStatus2 = GetGitStatus2;
...
//# sourceMappingURL=_simpleGit.js.map